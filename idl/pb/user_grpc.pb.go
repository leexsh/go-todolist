...
type UserServiceClient interface {
	...
	UserRegister(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResposne, error)
	UserLogout(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResposne, error)
}
...
func (c *userServiceClient) UserRegister(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResposne, error) {
	out := new(UserCommonResposne)
...
func (c *userServiceClient) UserLogout(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResposne, error) {
	out := new(UserCommonResposne)
...
type UserServiceServer interface {
	...
	UserRegister(context.Context, *UserRequest) (*UserCommonResposne, error)
	UserLogout(context.Context, *UserRequest) (*UserCommonResposne, error)
...
func (UnimplementedUserServiceServer) UserRegister(context.Context, *UserRequest) (*UserCommonResposne, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserRegister not implemented")
}
func (UnimplementedUserServiceServer) UserLogout(context.Context, *UserRequest) (*UserCommonResposne, error) {
